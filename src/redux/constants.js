...
export const SET_BATTLE_ON_SELECT = 'SET_BATTLE_ON_SELECT';
export const SET_BATTLE_PICKED_ATTACK = 'SET_BATTLE_PICKED_ATTACK';
export const SET_BATTLE_ENEMIES_PICKED_ATTACK = 'SET_BATTLE_ENEMIES_PICKED_ATTACK';
export const SET_BATTLE_ITEMS_LIST_DOM = 'SET_BATTLE_ITEMS_LIST_DOM';
